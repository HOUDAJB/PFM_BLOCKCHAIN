...
\begin{titlepage}
    ...
    % Logos en haut : gauche et droite alignés
    \noindent
    \begin{minipage}[c]{0.48\textwidth}
        \flushleft
        \includegraphics[height=2.5cm]{images/Logo_FST.png}
    \end{minipage}
    \hfill
    \begin{minipage}[c]{0.48\textwidth}
        \flushright
        \includegraphics[height=2.5cm]{images/Logo_CI.png}
    \end{minipage}

    \vspace{1.15cm}

    % En-tête de l'université avec couleurs
    {\Large\bfseries\color{primary} Université Moulay Ismaïl}\\[0.18cm]
    {\large\color{secondary} Faculté des Sciences et Techniques -- Errachidia}\\[0.15cm]
    {\normalsize Département Informatique}\\[0.15cm]
    {\normalsize Cycle d'Ingénieur -- Ingénierie Logicielle Intelligence Artificielle}\\[1.05cm]

    {\large Rapport de projet en Blockchain et Web3}\\[0.85cm]

    % Ligne de séparation colorée
    \textcolor{secondary}{\rule{0.75\textwidth}{1pt}}\\[0.7cm]

    {\Large\bfseries Module : Blockchain et Web3}\\[0.95cm]

    % Titre principal bien mis en évidence
    {\huge\bfseries\color{primary} Développement d'une application}\\[0.25cm]
    {\huge\bfseries\color{primary} décentralisée (dApp) pour les}\\[0.25cm]
    {\huge\bfseries\color{primary} exercices Solidity du TP3}\\[0.75cm]

    % Ligne de séparation colorée
    \textcolor{secondary}{\rule{0.75\textwidth}{1pt}}\\[3cm]

    % Blocs des noms parfaitement alignés au centre de leurs colonnes respectives
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        {\large\bfseries\color{secondary} Préparée par :}\\[0.35cm]
        {\normalsize\bfseries Houda JABAL}\\
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        {\large\bfseries\color{secondary} Encadré par :}\\[0.35cm]
        {\normalsize\bfseries Pr. Mohamed OUALLA}
    \end{minipage}

    \vfill

    % Année universitaire
    {\large\bfseries\color{primary} ANNÉE UNIVERSITAIRE 2025--2026}
\end{titlepage}
